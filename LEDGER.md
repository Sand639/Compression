...
### イテレーション8: APM4コンテキスト 4096→8192（10bit cx[3]+bitpos）
- 何を: apm4を4096*65から8192*65に拡張。cx[3]ハッシュ9bit(>>23)→10bit(>>22)。
- なぜ: cx[3]は3バイトコンテキストでcx[2]より情報量が多い。10bitで恩恵があるかもしれない。
