...
//   io.cpp         : ファイル / パス入出力
//   archive.cpp    : ARC3 コンテナ + ファイル単位トーナメント圧縮 + フォルダ圧縮/復元
...
// CM/Shift-JISモデル追加で旧ビットストリームと非互換になったためARC3へ更新。
static const char ARCHIVE_MAGIC[4] = {'A', 'R', 'C', '3'};
...
// ---- archive.cpp (ARC3 コンテナ / ファイル単位圧縮 / フォルダ圧縮・復元) ----
