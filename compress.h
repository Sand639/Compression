...
static const CMProfile CM_PROF_SLOW { CM_RATE_SLOW, 11, 8, 24, 2, 29 };   // テキスト (CM): tbits 27->29
static const CMProfile CM_PROF_BMP  { CM_RATE_BMP,  13, 8, 24, 3, 29 };   // 画像 (BMP_CM): mixShift 12->13, tbits 27->29
static const CMProfile CM_PROF_FAST { CM_RATE_FAST, 10, 7, 14, 2, 29 };   // exe (BCJ_CM)
static const CMProfile CM_PROF_WAV  { CM_RATE_WAV,  11, 7, 25, 4, 29 };   // 音声 (WAV_CM): subShift 24->25, tbits 27->29
