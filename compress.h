...
struct CMProfile { const int* rate; int mixShift; int apmShift; int subShift; int strideLen; int tbits; bool applyPrior = true; int preset = 0; };
...
static const CMProfile CM_PROF_YUUKI { CM_RATE_WAV, 11, 7, 24, 4, 27, false, 1 };     // raw index BMP専用prior
